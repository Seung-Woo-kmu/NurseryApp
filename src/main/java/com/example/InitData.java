...
public class InitData {
    ...
    public void members() {
        ...
        Member memberA = new Member("asd1qw2", encoder.encode("qwer1234sss"), "유승우", "기린", "하니어린이집", "010-1111-1111", Authority.NORMAL, Gender.MAN, "sleeper.jpg");
        Member memberB = new Member("qwe123qq", encoder.encode("qwer1234sss"), "유태근", "낙타", "하니어린이집", "010-2222-1111", Authority.NORMAL, Gender.MAN, "sleeper.jpg");
        Member memberC = new Member("qwe123saa", encoder.encode("qwer1234sss"), "이지원", "강아지", "하니어린이집", "010-2222-1234", Authority.NORMAL, Gender.MAN, "sleeper.jpg");
